function[pos, mov] = MovingObject(video, outline_thick, area, xy)

    %{
    This function tracks the intersect of water on an object which is moving. 
    The main difference between this and StationaryObject is that this
    function constantly re-evaulates the vertical edges while
    StationaryObject evaluates it only once (the first frame)

    NOTE: this function is the most finnicky and if at all possible
    shouldn't be used because the vertical edge detection is very sensitive
    ...
    for t = 1:NumberOfFrames
        ...
        %get the horizontal and vertical edge componenets of the image
